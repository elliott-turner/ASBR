...
result = IK_pa4(setup.Robot,setup.LastJointIndex,config_a,p_goal,0.003,100,1,0)
visualizeResult(setup,result,p_goal);

result = IK_pa4(setup.Robot,setup.LastJointIndex,config_a,p_goal,0.003,100,0.95,0.05)
visualizeResult(setup,result,p_goal);

function visualizeResult(setup,result,p_goal)
    figure();
    hold on;
